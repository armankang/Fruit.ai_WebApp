...
const FAQSection = () => {
  ...
  useEffect(() => {
    axios.get("https://fruit-ai-web-app.vercel.app/faqs")
  ...
  const handleAddFaq = () => {
    ...
    if (editingIndex === null) {
      axios.post("https://fruit-ai-web-app.vercel.app/faqs", newFaq)
        .then((response) => {
      ...
      axios.put(`https://fruit-ai-web-app.vercel.app/faqs/${id}`, newFaq)
        .then((response) => {
  ...
  const handleDeleteFaq = (index) => {
    ...
    axios.delete(`https://fruit-ai-web-app.vercel.app/faqs/${id}`)
      .then(() => {
